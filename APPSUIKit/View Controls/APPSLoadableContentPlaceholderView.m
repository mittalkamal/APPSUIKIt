...
@interface APPSLoadableContentPlaceholderView ()
...
@implementation APPSLoadableContentPlaceholderView
...
- (instancetype)initWithFrame:(CGRect)frame title:(NSString *)title message:(NSString *)message image:(UIImage *)image buttonTitle:(NSString *)buttonTitle buttonAction:(dispatch_block_t)buttonAction
{
    ...
    _titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:22.0];
    ...
    _messageLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:14.0];
    ...
    _actionButton.titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:14.0];
    _actionButton.translatesAutoresizingMaskIntoConstraints = NO;
    _actionButton.contentEdgeInsets = UIEdgeInsetsMake(0, 16, 0, 16);
    [_actionButton setBackgroundImage:[self apps_buttonBackgroundImageWithColor:textColor] forState:UIControlStateNormal];
...
- (UIImage *)apps_buttonBackgroundImageWithColor:(UIColor *)color
{
...
@interface APPSTablePlaceholderView ()
@property (nonatomic, strong) UIActivityIndicatorView *activityIndicatorView;
@property (nonatomic, strong) APPSLoadableContentPlaceholderView *placeholderView;
@end

@implementation APPSTablePlaceholderView
...
{
	APPSLoadableContentPlaceholderView *placeholderView = _placeholderView;
...
{
	APPSLoadableContentPlaceholderView *oldPlaceHolder = self.placeholderView;
	...
	self.placeholderView = [[APPSLoadableContentPlaceholderView alloc] initWithFrame:CGRectZero title:title message:message image:image buttonTitle:nil buttonAction:nil];
...
@interface APPSPlaceholderCell ()
@property (nonatomic, strong) APPSLoadableContentPlaceholderView *placeholderView;
@end

@implementation APPSPlaceholderCell
