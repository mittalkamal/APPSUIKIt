...
static NSString * const APPSStateNil = @"Nil";

@implementation APPSStateMachine {
...
- (id)target
{
	id<APPSStateMachineDelegate> delegate = self.delegate;
	if (delegate)
		return delegate;
	return self;
}
...
{
    id<APPSStateMachineDelegate> delegate = _delegate;
...
- (void)performTransitionFromState:(NSString *)fromState toState:(NSString *)toState
{
    ...
    NSString *fromStateNotNil = fromState ?: APPSStateNil;
